<div class="rounded-3xl border border-white/10 bg-stone-950/40 p-4">
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex w-full max-w-xl items-center gap-3">
            ...
            >
            <button x-show="searchQuery.trim() !== ''" x-cloak x-on:click="searchQuery = ''; clearSearch()" type="button" class="rounded-2xl border border-white/10 px-4 py-3 text-sm font-semibold text-stone-100 transition hover:border-orange-300/40 hover:text-orange-200">
                Clear
            </button>
        </div>
    </div>
